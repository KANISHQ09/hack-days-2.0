...
const defaultData = [
  { name: "Food & Dining", value: 1450, color: "#3b82f6" },
  { name: "Housing & Rent", value: 1850, color: "#10b981" },
  { name: "Subscriptions", value: 280, color: "#8b5cf6" },
  { name: "Bills & Utilities", value: 420, color: "#f59e0b" },
]
